package com.waither.userservice.common.config;


import com.waither.userservice.accounts.jwt.filter.JwtAuthenticationFilter;
import com.waither.userservice.accounts.jwt.filter.JwtAuthorizationFilter;
import com.waither.userservice.accounts.jwt.filter.JwtLogoutFilter;
...
public class SecurityConfig {
    ...
    private final String[] authUrls = {"/", "/signup/**", "/login/**", "/reissue"};
